...
MITRAD = ${SIMHD}/Mitra
MITRA = ${MITRAD}/mitra_cpu.c ${MITRAD}/mitra_instr.c ${MITRAD}/mitra_instr_utils.c ${MITRAD}/mitra_deroute.c ${MITRAD}/mitra_RD_WD.c ${MITRAD}/mitra_io.c \
	${MITRAD}/IO_asr33.c \
...
ALL = pdp1 pdp4 pdp7 pdp8 pdp9 pdp15 pdp11 pdp10 \
	...
	sigma mitra uc15 pdp10-ka pdp10-ki pdp10-kl pdp10-ks pdp6 i650 \
...
${BIN}mitra${EXE} : ${MITRA} ${SIM}
	${MKDIRBIN}
	${CC} ${MITRA} ${SIM} ${MITRA_OPT} ${CC_OUTSPEC} ${LDFLAGS}
ifneq (,$(call find_test,${MITRAD},mitra))
	$@ $(call find_test,${MITRAD},mitra) ${TEST_ARG}
endif
