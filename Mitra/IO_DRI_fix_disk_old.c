...
t_stat dri_wd(uint16 inst)
{
    ...
    switch (cpu_state.reg_E) {
        case 3:   /* Selection */
            ...
            if (cpu_state.reg_A & 0x80) dri_state[last_selected].operation = 1;  /* write */
            else if (cpu_state.reg_A & 0xF0) dri_state[last_selected].operation = 2; /* compare */
        ...
        case 0x15: /* Start transfer */
            {
                ...
                dri_start_transfer(last_selected, mem_addr, byte_count, cpu_state.reg_A,
